...
export class Migration20230509115642 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "contact" ("uuid" uuid not null default uuid_generate_v4(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "resource_country_acronym" varchar(4) not null, "resource_uuid" uuid not null, "person_uuid" uuid not null, "data" jsonb not null, constraint "contact_pkey" primary key ("uuid"));',
    );

    this.addSql(
      'create table "establishment" ("uuid" uuid not null default uuid_generate_v4(), "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "resource_country_acronym" varchar(4) not null, "resource_uuid" uuid not null, "person_uuid" uuid not null, "country_uuid" uuid not null, "city_uuid" uuid not null, "data" jsonb not null, constraint "establishment_pkey" primary key ("uuid"));',
    );
    ...
    this.addSql(
      'alter table "contact" add constraint "contact_resource_country_acronym_foreign" foreign key ("resource_country_acronym") references "resource_country" ("acronym") on update cascade;',
    );
    this.addSql(
      'alter table "contact" add constraint "contact_resource_uuid_foreign" foreign key ("resource_uuid") references "resource" ("uuid") on update cascade;',
    );
    this.addSql(
      'alter table "contact" add constraint "contact_person_uuid_foreign" foreign key ("person_uuid") references "person" ("uuid") on update cascade;',
    );

    this.addSql(
      'alter table "establishment" add constraint "establishment_resource_country_acronym_foreign" foreign key ("resource_country_acronym") references "resource_country" ("acronym") on update cascade;',
    );
    this.addSql(
      'alter table "establishment" add constraint "establishment_resource_uuid_foreign" foreign key ("resource_uuid") references "resource" ("uuid") on update cascade;',
    );
    this.addSql(
      'alter table "establishment" add constraint "establishment_person_uuid_foreign" foreign key ("person_uuid") references "person" ("uuid") on update cascade;',
    );
    this.addSql(
      'alter table "establishment" add constraint "establishment_country_uuid_foreign" foreign key ("country_uuid") references "address"."country" ("uuid") on update cascade;',
    );
    this.addSql(
      'alter table "establishment" add constraint "establishment_city_uuid_foreign" foreign key ("city_uuid") references "address"."city" ("uuid") on update cascade;',
    );
  }
